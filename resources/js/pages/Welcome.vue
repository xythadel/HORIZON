          ...
          <!-- Sign Up Page (Correct Layout) -->
            ...
            <div class="relative z-10 w-full max-w-6xl flex flex-col md:flex-row items-center justify-between">
               ...
               <!-- Pill 1: Circle on the right -->
                ...
                <!-- Pill 2 -->
                <div class="flex items-center gap-4 bg-gradient-to-r from-yellow-500 to-orange-300 text-white rounded-full px-6 py-4 shadow-lg"
               style="
            ...
            <div class="relative z-10 w-full max-w-6xl flex flex-col md:flex-row items-center justify-between">
                ...
                >
                 <div class="bg-yellow-400 rounded-full ml-auto" style="width: 125px; height: 100px;"></div>
                    <p class="text-3xl font-bold text-black">
                    Welcome Back!
                    </p>
                ...
                >
                    ...
                    <p class="text-2xl font-bold text-black" style="order: 0;">
                    Enter your credentials
                    </p>
                    <div class="bg-purple-700 rounded-full" style="width: 125px; height: 100px; order: 1;"></div>
                </div>

                <!-- Pill 3 -->
                <div 
                    class="flex items-center gap-4 bg-gradient-to-r from-red-500 to-orange-400 text-white rounded-full px-6 py-4 shadow-lg"
                    style="padding: 16px 20px; width: 100%; max-width: 400px; height: 120px; justify-content: flex-start; gap: 30px;"
                >
                 <div 
                    class="bg-red-600 rounded-full flex items-center justify-center text-black text-5xl font-bold"
                ...
                <div class="p-8 text-white w-full max-w-md mt-12 md:mt-0" >
                <div class="text-left mb-8 text-white">
